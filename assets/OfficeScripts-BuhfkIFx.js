import{j as e}from"./index-B7FO_Trq.js";import{P as o}from"./PageContainer-D5OsdXj6.js";import{C as t}from"./CodeBlock-CjZI5FLa.js";function s(){return e.jsxs(o,{title:"Office Scripts (TypeScript no Excel)",subtitle:"A sucessora moderna do VBA — funciona no Excel Online.",difficulty:"avancado",timeToRead:"7 min",children:[e.jsx("h2",{children:"O que é"}),e.jsxs("ul",{children:[e.jsx("li",{dangerouslySetInnerHTML:{__html:"Linguagem: <strong>TypeScript</strong>"}}),e.jsx("li",{dangerouslySetInnerHTML:{__html:"Executa em <strong>Excel Online</strong> (também Desktop com 365)"}}),e.jsx("li",{dangerouslySetInnerHTML:{__html:"Editor com IntelliSense embutido na nuvem"}}),e.jsx("li",{dangerouslySetInnerHTML:{__html:'Usa <code>workbook.getWorksheet("Plan1")</code> em vez de <code>Worksheets("Plan1")</code>'}})]}),e.jsx("h2",{children:"Hello World"}),e.jsx(t,{language:"text",code:`function main(workbook: ExcelScript.Workbook) {
