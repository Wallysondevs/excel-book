import{j as a}from"./index-B7FO_Trq.js";import{P as i}from"./PageContainer-D5OsdXj6.js";import{C as e}from"./CodeBlock-CjZI5FLa.js";function m(){return a.jsxs(i,{title:"DIVIDIRTEXTO — split em uma fórmula",subtitle:"Quebra texto em várias colunas/linhas por delimitador.",difficulty:"intermediario",timeToRead:"5 min",children:[a.jsx("h2",{children:"Sintaxe"}),a.jsx(e,{language:"text",code:"=DIVIDIRTEXTO( texto ; col_delim ; [linha_delim] ; [ignorar_vazias] ; [diferenciar] ; [preencher_com] )"}),a.jsx("h2",{children:"Exemplos"}),a.jsx(e,{language:"text",code:`=DIVIDIRTEXTO( "maçã,banana,uva" ; "," )
