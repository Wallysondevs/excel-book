import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function EOu() {
    return (
      <PageContainer title="E, OU, NÃO — Lógica Booleana" subtitle="Combinando condições nas fórmulas SE e na Formatação Condicional." difficulty="iniciante" timeToRead="6 min">
        <h2>E — todas as condições verdadeiras</h2>
      <CodeBlock language="text" code={`=E(A2>0; A2<100)            → VERDADEIRO se A2 entre 1 e 99
  =E(B2="SP"; C2>5000)        → SP E venda > 5000
  =SE(E(A2>=7; B2>=7); "Aprovado"; "Recuperação")`} />
      <h2>OU — ao menos uma verdadeira</h2>
      <CodeBlock language="text" code={`=OU(A2="SP"; A2="RJ"; A2="MG")
  =SE(OU(B2<0; B2>1000); "fora do limite"; "ok")`} />
      <h2>NÃO — inverte</h2>
